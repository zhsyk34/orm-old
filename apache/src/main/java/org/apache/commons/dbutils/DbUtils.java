...
public final class DbUtils {
	...
	/**
	 * Default constructor. <p> Utility classes should not have a public or default constructor, but
	 * this one preserves retro-compatibility.
	 *
	 * @since 1.4
	 */
	public DbUtils() {
	...
	/**
	 * Close a <code>Connection</code>, avoid closing if null and hide any SQLExceptions that
	 * occur.
	 *
	 * @param conn Connection to close.
	 */
	...
	/**
	 * Close a <code>Connection</code>, <code>Statement</code> and <code>ResultSet</code>.  Avoid
	...
	/**
	 * Commits a <code>Connection</code> then closes it, avoid closing if null and hide any
	...
	/**
	 * Loads and registers a database driver class. If this succeeds, it returns true, else it
	 * returns false.
	 *
	...
	/**
	 * Performs a rollback on the <code>Connection</code> then closes it, avoid closing if null and
